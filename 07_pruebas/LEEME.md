...
| `visual-23-09/` | **C50: la imagen deja de ser una diapositiva.** Muestrario con tres variantes (archivo + frase, archivo + subtítulos, imágenes generadas) sobre los tres Shorts de la semana, montado por el workflow `visual_prueba.yml` de la carpeta. Ver `visual-23-09.md` | **Esperando** a la tarea 2 del codirector del 23/09 (cuentas, claves y el workflow). Después, **lo mira el codirector y elige** |
